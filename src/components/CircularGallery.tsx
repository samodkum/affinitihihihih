...
class Media {
  ...
  createShader() {
    ...
    img.onerror = () => {
      console.warn(`Failed to load image: ${this.image}, falling back to placeholder`);
      ...
      if (ctx) {
        ...
        ctx.strokeStyle = 'rgba(255, 140, 26, 0.15)';
        ctx.beginPath();
...
export default function CircularGallery({
  ...
  }, [items, bend, textColor, borderRadius, font, fontUrl, scrollSpeed, scrollEase, autoplay, autoplaySpeed]);
  return (
    <div
